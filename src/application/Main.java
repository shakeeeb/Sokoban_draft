...
public class Main extends Application {
    ...
    static String PROPERTY_TYPES_LIST = "property_types.txt"; // DONT WORRY IT ISNT USED    
    ...
    public enum SokobanPropertyType {
        ...
        /* IMAGE FILE NAMES */
        WINDOW_ICON, SPLASH_SCREEN_IMAGE_NAME, GAME_IMG_NAME, STATS_IMG_NAME, UNDO_IMG_NAME, EXIT_IMG_NAME, NEW_GAME_IMG_NAME, HOME_IMG_NAME, BACK_IMG_NAME,
        /* DATA FILE STUFF */
